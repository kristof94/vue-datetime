...
(function (global, factory) {
  ...
  var Datetime = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime" }, [_vm._t("before"), _vm._v(" "), _c('button', _vm._g(_vm._b({ staticClass: "vdatetime-input", class: _vm.inputClass, attrs: { "id": _vm.inputId, "value": _vm.inputValue }, on: { "click": _vm.open, "focus": _vm.open } }, 'button', _vm.$attrs, false), _vm.$listeners), [_vm.hiddenName ? _c('input', { attrs: { "type": "hidden", "name": _vm.hiddenName }, domProps: { "value": _vm.value }, on: { "input": _vm.setValue } }) : _vm._e(), _vm._v(" "), _vm._t("after"), _vm._v(" "), _c('transition-group', { attrs: { "name": "vdatetime-fade", "tag": "div" } }, [_vm.isOpen ? _c('div', { key: "overlay", staticClass: "vdatetime-overlay", on: { "click": function click($event) {
            if ($event.target !== $event.currentTarget) {
              return null;
            }return _vm.cancel($event);
          } } }) : _vm._e(), _vm._v(" "), _vm.isOpen ? _c('datetime-popup', { key: "popup", attrs: { "type": _vm.type, "datetime": _vm.popupDate, "phrases": _vm.phrases, "use12-hour": _vm.use12Hour, "hour-step": _vm.hourStep, "minute-step": _vm.minuteStep, "min-datetime": _vm.popupMinDatetime, "max-datetime": _vm.popupMaxDatetime, "auto": _vm.auto, "week-start": _vm.weekStart }, on: { "confirm": _vm.confirm, "cancel": _vm.cancel } }) : _vm._e()], 1)], 2)], 2);
    }, staticRenderFns: [],
    components: {
