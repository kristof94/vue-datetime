...
(function (global, factory) {
  ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, __webpack_require__(0)) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.VueDatetimeCustom = global.VueDatetimeCustom || {}, global.luxon);
  ...
  function weekStart() {
    ...
    try {
      weekstart = __webpack_require__(17);
    } catch (e) {
  ...
  var Datetime = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime" }, [_vm._t("before"), _vm._v(" "), _c('span', _vm._g(_vm._b({ class: _vm.inputClass, attrs: { "id": _vm.inputId }, on: { "click": _vm.open, "focus": _vm.open } }, 'span', _vm.$attrs, false), _vm.$listeners), [_c('font-awesome-icon', { attrs: { "icon": ['fa', 'calendar-alt'] } })], 1), _vm._v(" "), _vm.hiddenName ? _c('input', { attrs: { "type": "hidden", "name": _vm.hiddenName }, domProps: { "value": _vm.value }, on: { "input": _vm.setValue } }) : _vm._e(), _vm._v(" "), _vm._t("after"), _vm._v(" "), _c('transition-group', { attrs: { "name": "vdatetime-fade", "tag": "div" } }, [_vm.isOpen ? _c('div', { key: "overlay", staticClass: "vdatetime-overlay", on: { "click": function click($event) {
            if ($event.target !== $event.currentTarget) {
              return null;
            }return _vm.cancel($event);
          } } }) : _vm._e(), _vm._v(" "), _vm.isOpen ? _c('datetime-popup', { key: "popup", attrs: { "type": _vm.type, "datetime": _vm.popupDate, "phrases": _vm.phrases, "use12-hour": _vm.use12Hour, "hour-step": _vm.hourStep, "minute-step": _vm.minuteStep, "min-datetime": _vm.popupMinDatetime, "max-datetime": _vm.popupMaxDatetime, "auto": _vm.auto, "week-start": _vm.weekStart }, on: { "confirm": _vm.confirm, "cancel": _vm.cancel } }) : _vm._e()], 1)], 2);
    }, staticRenderFns: [],
    components: {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js??ref--2-2!./vue-datetime-custom.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js??ref--2-2!./vue-datetime-custom.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _vueDatetimeCustom = __webpack_require__(4);

var _vueDatetimeCustom2 = _interopRequireDefault(_vueDatetimeCustom);
...
_vue2.default.use(_vueDatetimeCustom2.default);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__langRegionMap_js__ = __webpack_require__(16);
